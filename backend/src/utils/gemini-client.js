 ...
 * Gemini API Client
 * 
 * Centralized client for Google Gemini AI API calls.
 * Provides a singleton-like pattern for configuration and reuse.
 * 
...
/**
 * Generate content and parse JSON from response
 * 
 * @param {string} prompt - The prompt that should generate JSON
 * @param {Object} options - Optional configuration
 * @returns {Promise<{success: boolean, data?: Object, text?: string, error?: string}>}
 */
 ...
 * 
 * @returns {Promise<{available: boolean, responseTime?: number, error?: string}>}
 */
